...
const PAY2_APPROVAL_LABELS = ['실패', '성공', '총판승인대기', '승인처리대기', '승인처리중', '승인취소중'];

const MOCK_ING_ORDERS = [
  { ORDER_NO: 'ORD20260609001', ORDER_DT: '2026-06-09 09:30', ORDER_STAT_NM: '배송중',   ORDER_STAT_CD: 'DELIVERING', TOTAL_PRICE: 1200000, GOODS_COUNT: 2, STORE_NM: '글로벌트레이드',   CONTRACT_TYPE: '결제대행', PAY_CARD: '삼성카드', REMIT_TYPE: '계좌이체', REMIT_DT: '2026-06-10', REMIT_AMOUNT: 1266000, REMITTER: '박철수', REMIT_BANK: '국민은행', REMIT_ACCOUNT: '123456-04-123456', STATEMENT_YN: 'N', CARD_TRADE_NO: '26060905781234', ORDER_TYPE: '장바구니', PAY2_APPROVAL_STAT: 3 },
  { ORDER_NO: 'ORD20260608001', ORDER_DT: '2026-06-08 14:20', ORDER_STAT_NM: '주문접수', ORDER_STAT_CD: 'RECEIVED',   TOTAL_PRICE:  600000, GOODS_COUNT: 2, STORE_NM: '대한도매',        CONTRACT_TYPE: '구매대행', PAY_CARD: '국민카드', REMIT_TYPE: '계좌이체', REMIT_DT: '2026-06-09', REMIT_AMOUNT:  633000, REMITTER: '김도현', REMIT_BANK: '신한은행', REMIT_ACCOUNT: '234567-02-234567', STATEMENT_YN: 'N', CARD_TRADE_NO: '26060814452301', ORDER_TYPE: '발주서', PAY2_APPROVAL_STAT: 5 },
];

const MOCK_END_ORDERS = [
  { ORDER_NO: 'ORD20260607001', ORDER_DT: '2026-06-07 10:15', ORDER_STAT_NM: '배송완료', ORDER_STAT_CD: 'COMPLETED', TOTAL_PRICE:  350000, GOODS_COUNT: 2, DELIVERY_DT: '2026-06-08', STORE_NM: '비즈링크 직영몰', CONTRACT_TYPE: '결제대행', PAY_CARD: '삼성카드', REMIT_TYPE: '카드결제', REMIT_DT: '2026-06-08', REMIT_AMOUNT:  369250, REMITTER: '홍철동', REMIT_BANK: '하나은행', REMIT_ACCOUNT: '345678-11-345678', STATEMENT_YN: 'Y', CARD_TRADE_NO: '26060710239876', ORDER_TYPE: '장바구니', PAY2_APPROVAL_STAT: 1 },
  { ORDER_NO: 'ORD20260605001', ORDER_DT: '2026-06-05 08:45', ORDER_STAT_NM: '배송완료', ORDER_STAT_CD: 'COMPLETED', TOTAL_PRICE: 2050000, GOODS_COUNT: 2, DELIVERY_DT: '2026-06-06', STORE_NM: '글로벌트레이드',   CONTRACT_TYPE: '구매대행', PAY_CARD: '신한카드', REMIT_TYPE: '계좌이체', REMIT_DT: '2026-06-06', REMIT_AMOUNT: 2162750, REMITTER: '박철수', REMIT_BANK: '국민은행', REMIT_ACCOUNT: '123456-04-123456', STATEMENT_YN: 'N', CARD_TRADE_NO: '26060508671245', ORDER_TYPE: '발주서', PAY2_APPROVAL_STAT: 2 },
  { ORDER_NO: 'ORD20260601001', ORDER_DT: '2026-06-01 11:00', ORDER_STAT_NM: '배송완료', ORDER_STAT_CD: 'COMPLETED', TOTAL_PRICE: 1530000, GOODS_COUNT: 2, DELIVERY_DT: '2026-06-02', STORE_NM: '대한도매',        CONTRACT_TYPE: '결제대행', PAY_CARD: '삼성카드', REMIT_TYPE: '계좌이체', REMIT_DT: '2026-06-02', REMIT_AMOUNT: 1614150, REMITTER: '김도현', REMIT_BANK: '신한은행', REMIT_ACCOUNT: '234567-02-234567', STATEMENT_YN: 'Y', CARD_TRADE_NO: '26060111098765', ORDER_TYPE: '장바구니', PAY2_APPROVAL_STAT: 0 },
];
