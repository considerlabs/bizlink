...
const MOCK_ING_ORDERS = [
  { ORDER_NO: 'ORD20260609001', ORDER_DT: '2026-06-09 09:30', ORDER_STAT_NM: '배송중',   ORDER_STAT_CD: 'DELIVERING', TOTAL_PRICE: 1200000, GOODS_COUNT: 2, STORE_NM: '글로벌트레이드',   CONTRACT_TYPE: '결제대행', PAY_CARD: '삼성카드', REMIT_TYPE: '계좌이체', REMIT_DT: '2026-06-10', REMIT_AMOUNT: 1266000, REMIT_BANK: '국민은행', STATEMENT_YN: 'N' },
  { ORDER_NO: 'ORD20260608001', ORDER_DT: '2026-06-08 14:20', ORDER_STAT_NM: '주문접수', ORDER_STAT_CD: 'RECEIVED',   TOTAL_PRICE:  600000, GOODS_COUNT: 2, STORE_NM: '대한도매',        CONTRACT_TYPE: '구매대행', PAY_CARD: '국민카드', REMIT_TYPE: '계좌이체', REMIT_DT: '2026-06-09', REMIT_AMOUNT:  633000, REMIT_BANK: '신한은행', STATEMENT_YN: 'N' },
];

const MOCK_END_ORDERS = [
  { ORDER_NO: 'ORD20260607001', ORDER_DT: '2026-06-07 10:15', ORDER_STAT_NM: '배송완료', ORDER_STAT_CD: 'COMPLETED', TOTAL_PRICE:  350000, GOODS_COUNT: 2, DELIVERY_DT: '2026-06-08', STORE_NM: '비즈링크 직영몰', CONTRACT_TYPE: '결제대행', PAY_CARD: '삼성카드', REMIT_TYPE: '카드결제', REMIT_DT: '2026-06-08', REMIT_AMOUNT:  369250, REMIT_BANK: '하나은행', STATEMENT_YN: 'Y' },
  { ORDER_NO: 'ORD20260605001', ORDER_DT: '2026-06-05 08:45', ORDER_STAT_NM: '배송완료', ORDER_STAT_CD: 'COMPLETED', TOTAL_PRICE: 2050000, GOODS_COUNT: 2, DELIVERY_DT: '2026-06-06', STORE_NM: '글로벌트레이드',   CONTRACT_TYPE: '구매대행', PAY_CARD: '신한카드', REMIT_TYPE: '계좌이체', REMIT_DT: '2026-06-06', REMIT_AMOUNT: 2162750, REMIT_BANK: '국민은행', STATEMENT_YN: 'N' },
  { ORDER_NO: 'ORD20260601001', ORDER_DT: '2026-06-01 11:00', ORDER_STAT_NM: '배송완료', ORDER_STAT_CD: 'COMPLETED', TOTAL_PRICE: 1530000, GOODS_COUNT: 2, DELIVERY_DT: '2026-06-02', STORE_NM: '대한도매',        CONTRACT_TYPE: '결제대행', PAY_CARD: '삼성카드', REMIT_TYPE: '계좌이체', REMIT_DT: '2026-06-02', REMIT_AMOUNT: 1614150, REMIT_BANK: '신한은행', STATEMENT_YN: 'Y' },
];
...
const MOCK_VENDOR_APPROVALS = [
  { id: 1, name: '프레시마트',  biz_num: '111-22-33333', rep: '이순신',   contact: '02-111-2222',  email: 'fresh@mart.co.kr',    address: '서울특별시 마포구 양화로 123',         bank: '국민은행', account: '123-456789-01234', remitter: '이순신', memo: '신선식품 전문 유통사', applied: '2026-06-01', status: '승인완료', status_cd: 'APPROVED',  reviewed: '2026-06-03', reviewer: '관리자', reject_reason: null,                     docs: ['사업자등록증.pdf', '통장사본.jpg'] },
  { id: 2, name: '대성유통',    biz_num: '222-33-44444', rep: '강감찬',   contact: '031-222-3333', email: 'daesung@dist.co.kr',   address: '경기도 수원시 영통구 광교로 45',       bank: '신한은행', account: '234-567890-12345', remitter: '강감찬', memo: '',             applied: '2026-06-03', status: '검토중',   status_cd: 'REVIEWING', reviewed: null,         reviewer: null,   reject_reason: null,                     docs: ['사업자등록증.pdf', '통장사본.pdf', '거래명세서.pdf'] },
  { id: 3, name: '하나식품',    biz_num: '333-44-55555', rep: '장보고',   contact: '032-333-4444', email: 'hana@food.co.kr',      address: '인천광역시 남동구 논현로 78',          bank: '하나은행', account: '345-678901-23456', remitter: '장보고', memo: '냉동식품 전문', applied: '2026-06-05', status: '반려',     status_cd: 'REJECTED',  reviewed: '2026-06-07', reviewer: '관리자', reject_reason: '제출 서류 내용이 사업자등록증과 일치하지 않습니다.', docs: ['사업자등록증.pdf'] },
  { id: 4, name: '서울식자재',  biz_num: '444-55-66666', rep: '세종대왕', contact: '02-444-5555',  email: 'seoul@food.co.kr',    address: '서울특별시 강서구 마곡중앙로 10',      bank: '우리은행', account: '456-789012-34567', remitter: '세종대왕', memo: '식자재 대량 공급', applied: '2026-06-08', status: '승인완료', status_cd: 'APPROVED',  reviewed: '2026-06-10', reviewer: '관리자', reject_reason: null,                     docs: ['사업자등록증.pdf', '통장사본.jpg'] },
  { id: 5, name: '글로벌푸드',  biz_num: '555-66-77777', rep: '유관순',   contact: '033-555-6666', email: 'global@food.co.kr',    address: '강원도 춘천시 후평로 33',              bank: '농협은행', account: '567-890123-45678', remitter: '유관순', memo: '',             applied: '2026-06-10', status: '검토중',   status_cd: 'REVIEWING', reviewed: null,         reviewer: null,   reject_reason: null,                     docs: ['사업자등록증.pdf', '통장사본.pdf'] },
];
